...
namespace BigNum
{
    ...
    public class BigFloat
    {
        ...
        public static PrecisionSpec spec = new PrecisionSpec(30, PrecisionSpec.BaseType.QWORDS);
        ...
        public static explicit operator float(BigFloat v)
        {
            //return 0;
            return float.Parse(v.ToString());
        }
        public static explicit operator BigFloat(float v)
        {
            return new BigFloat((double)v, spec);
        }
